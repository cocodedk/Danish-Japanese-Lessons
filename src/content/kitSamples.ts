...
export const KIT_SHEET_ENTRY = defineEntry({ id: 'interface-kit-write-line', kind: 'phrase', ja: 'روی خط بنویس.', da: 'Skriv på linjen.', pron: { da: 'ruje khat benevis', ipa: 'ɾuːje xæt beneviːs' } })
