...
export const bridgeEntriesA = {
  pedar: bridgeEntry({
    id: 'pedar', ja: 'پدر', jaMarked: 'پِدَر', da: 'far', pronDa: 'pedar', ipa: 'peˈdæɾ',
    readingCues: [consonant(0, 'پ'), shortVowel(1, '◌ِ', 'e i “let”', 'e'),
      consonant(1, 'د'), shortVowel(2, '◌َ', 'a i “kat”', 'æ'), consonant(2, 'ر')],
  }),
  madar: bridgeEntry({
    id: 'madar', ja: 'مادر', jaMarked: 'مادَر', da: 'mor', pronDa: 'mådar', ipa: 'mɒːˈdæɾ',
    readingCues: [consonant(0, 'م'), longAa(1), consonant(2, 'د'),
      shortVowel(3, '◌َ', 'a i “kat”', 'æ'), consonant(3, 'ر')],
  }),
  baradar: bridgeEntry({
    id: 'baradar', ja: 'برادر', jaMarked: 'بَرادَر', da: 'bror', pronDa: 'barådar', ipa: 'bæɾɒːˈdæɾ',
