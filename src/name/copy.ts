...
// one file so the Japanese text-rule guard can walk it and a reader can hear the
...
export const WRITE_NAME_ENTRY = defineEntry({ id: 'names-write-name', kind: 'phrase', ja: 'نام خود را بنویس', da: 'Skriv dit eget navn', pron: { da: 'nåme khod rå benevis', ipa: 'nɒːme xod ɾɒː beneviːs' } })
export const ASSEMBLE_ENTRY = defineEntry({ id: 'names-assemble', kind: 'phrase', ja: 'نام را دوباره درست کن', da: 'Lav navnet igen', pron: { da: 'nåm rå dobåre dorost kon', ipa: 'nɒːm ɾɒː dobɒːɾe doɾost kon' } })

/** What the tray of tappable letters is, over both banks. */
export const LETTERS_ENTRY = defineEntry({ id: 'names-letters-label', kind: 'word', ja: 'حرف‌ها', da: 'Bogstaverne', pron: { da: 'harfhå', ipa: 'hæɾfhɒː' } })
 ...
 */
export const NOT_IN_NAME_ENTRY = defineEntry({ id: 'names-not-in-name', kind: 'phrase', ja: 'این حرف در نام تو نیست. دوباره نگاه کن.', da: 'Det bogstav er ikke i dit navn. Kig igen.', pron: { da: 'in harf dar nåme to nist. dobåre negåh kon.', ipa: 'iːn hæɾf dæɾ nɒːme to niːst dobɒːɾe negɒːh kon' } })

/** A common-word prompt for a correct name letter tapped too early. */
export const LATER_IN_NAME_ENTRY = defineEntry({ id: 'names-letter-later', kind: 'phrase', ja: 'این حرف را بعد بزن.', da: 'Tryk på dette bogstav senere.', pron: { da: 'in harf rå ba’d bezan', ipa: 'iːn hæɾf ɾɒː bæʔd bezæn' } })

/** The promise in the settings corner, said in both languages. */
export const PRIVACY_ENTRY = defineEntry({ id: 'names-privacy', kind: 'phrase', ja: 'نام فقط در این دستگاه است.', da: 'Navnet er kun på denne enhed.', pron: { da: 'nåm faghat dar in dastgåh ast', ipa: 'nɒːm fæɢæt dæɾ iːn dæstɡɒːh æst' } })
 ...
 * print a Japanese form inside them. Walked by the text-rule guard; the entries
