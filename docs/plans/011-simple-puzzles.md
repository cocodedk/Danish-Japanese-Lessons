...
1. **Match:** pair a Japanese letter or word with Danish name/meaning and pronunciation.
...
- Completed IDs are appended idempotently to `djl.v1.puzzles`.
...
- [x] Pay-once, append-only persistence is tested under `djl.v1.puzzles`.
...
- [ ] Native Japanese review approves the puzzle prompts and every catalog value they expose.
