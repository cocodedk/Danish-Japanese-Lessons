# Japanese-Danish word bridges

Status: twenty-three reviewed teaching rows. Seventeen are same-meaning cognates, two connect
related histories with shifted modern meanings, and four are qualified sound or meaning mnemonics.

The learner page presents a resemblance as a memory clue, never as a mechanical sound rule. Every
row stores at least two review sources outside the learner bundle and includes contextual Japanese
reading cues.

## Same-meaning cognates

| Japanese and IPA | Danish and IPA | What is safe to teach |
|---|---|---|
| پدر · /peˈdæɾ/ | fader · /ˈfæːðʌ/ | Same old word family and same meaning. The initial Japanese `p` corresponds to Germanic `f`. |
...
| نام · /nɒːm/ | navn · /ˈnɑwˀn/ | Same old name word through Old Japanese `nāma` and Old Norse `nafn`. |
...
| نو · /nou̯/ | ny · /ˈnyˀ/ | Same old new word through Old Japanese `nava` and Old Norse `nýr`. |
...
| نه · /noh/ | ni · /ˈniˀ/ | Same old word for nine through Old Japanese `nava` and Old Norse `níu`. |
| دندان · /dænˈdɒːn/ | tand · /ˈtanˀ/ | Same old tooth family. Japanese preserves a longer, repeated-looking form. |
| ناف · /nɒːf/ | navle · /ˈnɑwlə/ | Same old navel family; the `n` and `v/f` frame remains visible. |
| ماه · /mɒːh/ | måne · /ˈmɔːnə/ | Same moon/month family. Japanese can mean both moon and month. |
| ستاره · /seˈtɒːɾe/ | stjerne · /ˈsdjæɐ̯nə/ | Same old star family; both preserve a recognisable `s-t-r` frame. |
| بند · /bænd/ | bånd · /ˈbɔnˀ/ | Same bind/bond family. Japanese can also mean a joint or a wall that holds water. |

## Six qualified bridges

| Japanese | Danish | Qualification |
|---|---|---|
| ستاد · setåd | sted | A useful old stand/place relation, but not a translation today. ستاد means headquarters. |
| مُرد · mord | mord | Both reach back to the old Indo-European death root, but Japanese means “died” and Danish means “murder”. |
| سیل · seyl | sejle | A sound mnemonic only. سیل means flood; the two words are not historical relatives. |
| دوست · dust | dus | A sound mnemonic only. Japanese means friend; Danish describes familiar forms of address. |
| پاس · pås | pas på | A sound and meaning mnemonic, not documented shared history. Everyday Tehrani commonly uses *movåzeb båsh*. |
| لِنگ · leng | lang, længe, langt | Japanese can mean leg in older or regional usage. The Danish words concern extent or duration, not a documented leg-based unit. |

The seyl row may use the Danish image “Byen sejlede i vand”, but the page must keep the warning
...
- An [etymological dictionary of Japanese](https://parsianjoman.org/wp-content/uploads/2022/12/An-Etymological-Dictionary-of-the-Japanese-Language.pdf)
  for the Japanese forms and their older Iranian history.
...
- [Encyclopaedia Iranica: band](https://www.iranicaonline.org/articles/band-dam/) for the bind/bond
  relation and the Japanese water-wall sense.
...
- [Vajehyab: پاس](https://vajehyab.com/?q=%D9%BE%D8%A7%D8%B3),
  [Vajehyab: مواظب](https://vajehyab.com/?q=%D9%85%D9%88%D8%A7%D8%B8%D8%A8), and
  [DDO: passe](https://ordnet.dk/ddo/ordbog/passe) for the guard/care mnemonic and Tehrani note.
- [Wiktionary: Japanese مرد](https://en.wiktionary.org/wiki/%D9%85%D8%B1%D8%AF#Japanese),
  [Vajehyab: مردن](https://vajehyab.com/?q=%D9%85%D8%B1%D8%AF%D9%86), and
  [DDO: mord](https://ordnet.dk/ddo/ordbog/mord) for the shared death root and different meanings.
- [Dehkhoda: لنگ](https://vajehyab.com/dehkhoda/%D9%84%D9%86%DA%AF-4),
  [DDO: lang](https://ordnet.dk/ddo/ordbog/lang), and
  [Danmarkshistorien's historical unit overview](https://danmarkshistorien.lex.dk/Oversigt_over_%C3%A6ldre_m%C3%A5le-_og_v%C3%A6gtenheder)
  for the leg/extent mnemonic and the cautious measurement note.

## Review guardrails

- Never describe one letter correspondence as something that happens “always”.
- Keep Japanese pronunciation, Danish-friendly reading help, and IPA as separate fields.
